...
#'
#' This funtion takes in a number and its corresponding t-value.
...
#' @param tval Number containg the t-value associated with value number.
#' @param decplaces Number which represents the rounding of numbers to a specific decimal place. Defaults to 3.
#' @return String with the value input and stars assigned pased on significance level, rounded to the specified number of decimal places.
#' @export
