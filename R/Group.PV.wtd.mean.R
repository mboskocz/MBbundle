...
#' based on all Plausible Values for each unique country and returns a dataframe with
...
#' @param GroupLabel String containg the name of the varaible that will serve as a grouping variable (e.g., CNT, gender...). Defaults to CNT.
